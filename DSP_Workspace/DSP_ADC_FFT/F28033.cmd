...
PAGE 0:    /* Program Memory */
   ...
   RAML1L2L3   : origin = 0x008800, length = 0x001800  //6K   /* on-chip RAM block L1 & L2 $ L3 */
   OTP         : origin = 0x3D7800, length = 0x000400     /* on-chip OTP */

   FLASHH      : origin = 0x3F0000, length = 0x003000     /* on-chip FLASH */
...
//   FLASHF      : origin = 0x3F2000, length = 0x001000     /* on-chip FLASH */
   ...
   FLASHD      : origin = 0x3F4000, length = 0x002000     /* on-chip FLASH */
...
PAGE 1 :   /* Data Memory */
   ...
   RAMM0       : origin = 0x000050, length = 0x0003B0 //<1K    /* on-chip RAM block M0 */
   RAMM1       : origin = 0x000400, length = 0x000400 //1K    /* on-chip RAM block M1 */
//   RAML2       : origin = 0x008C00, length = 0x000400 //1K    /* on-chip RAM block L2 */
//   RAML3       : origin = 0x009000, length = 0x001000 //4K    /* on-chip RAM block L3 */
//   FLASHB      : origin = 0x3F6000, length = 0x001000     /* on-chip FLASH */
   RAML0       : origin = 0x008000, length = 0x000800  //2K   /* on-chip RAM block L0 */
...
//   ramfuncs            : > FLASHD,		PAGE = 0
   ...
   .stack              : > RAMM0       PAGE = 1
   .ebss               : > RAMM1       PAGE = 1 // RAML2
   .esysmem            : > RAMM1       PAGE = 1 // RAML2
	VecSpace		   : > RAML0	   PAGE = 1 // RAML3
